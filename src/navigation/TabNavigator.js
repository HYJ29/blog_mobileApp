...
export const CameraSettingNavigator = () => (
  <CameraStackNavigator.Navigator screenOptions={defaultNavOptions}>
    <CameraStackNavigator.Screen name="Camera" component={CameraScreen} />
...
export default function TabNavigator() {
  return (
    <GalleryBottomTabNavigator.Navigator>
      <GalleryBottomTabNavigator.Screen
        name="Gallery"
        component={GalleryNavigator}
      />
      <GalleryBottomTabNavigator.Screen
        name="CameraSetting"
        component={CameraSettingNavigator}
      />
      <GalleryBottomTabNavigator.Screen
        name="LocationList"
  ...
  return (
    <AuthStackNavigator.Navigator screenOptions={defaultNavOptions}>
      <AuthStackNavigator.Screen
        ...
        options={AuthScreen.screenOptions}
      />
